...
def create_chinese_pdf():
    ...
    <body>
        ...
        <div class="figure">
            <img src="algorand_algorithm_improved.png" alt="Algorand共识算法">
...
所有诚实节点是否达成一致: True
        ...
        <div class="figure">
            <img src="reset_strategy_table.png" alt="不同重置策略的比较">
    ...
    # 复制图像文件
    os.system('cp /home/ubuntu/algorand_fix/output/algorand_algorithm_improved.png /home/ubuntu/algorand_fix/output/')
    os.system('cp /home/ubuntu/algorand_fix/output/reset_strategy_table.png /home/ubuntu/algorand_fix/output/')
    ...
    # 转换HTML为PDF
    output_path = '/home/ubuntu/algorand_fix/output/assignment_zh_fixed_v2.pdf'
    HTML(html_path).write_pdf(output_path)
    
    # 删除临时HTML文件
    os.remove(html_path)
    
    print(f"修复后的中文PDF V2已生成: {output_path}")
